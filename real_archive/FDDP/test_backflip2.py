...
stateWeights = np.array([10] * 1 + [10] * (state.nv-1) + [10] * state.nv)
...
runningCostModel1.addCost("limitCost", limitCost, 1e8) #1e3
...
runningCostModel2UP.addCost("limitCost", limitCost, 1e8) #1e3
...
runningCostModel2UPR.addCost("limitCost", limitCost, 1e8) #1e3
...
terminalCostModel.addCost("limitCost", limitCost, 1e8) #1e7
...
ddp.solve(xs, us, 100, False, 1e-7)
