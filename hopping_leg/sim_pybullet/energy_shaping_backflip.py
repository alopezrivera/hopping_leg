...
from kinematics_simulation import SimulationTracker, HopperSimulation
...
sys.path.append("../Controllers/state_machine/")
from state_machine import GainScheduling

rail = 0
long_leg = 1

class GainSchedulingControl(LowLevelControl):
    TOUCHDOWN = "TOUCHDOWN"
    FLIGHT = "FLIGHT"
    LIFTOFF = "LIFTOFF"
...
class EnergyShapingControl(LowLevelControl):
    TOUCHDOWN = "TOUCHDOWN"
    FLIGHT = "FLIGHT"
    LIFTOFF = "LIFTOFF"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gain_scheduling", "-g", action='store_true',
                        help="Use gain scheduling control mode")
    parser.add_argument("--energy_shaping", "-e", action='store_true',
                        help="Use energy shaping control mode")
    parser.add_argument("--backflip", "-b", action='store_true',
                        help="Use backflip control mode")
