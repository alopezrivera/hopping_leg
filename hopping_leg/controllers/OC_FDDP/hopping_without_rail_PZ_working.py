...
lowerLimit2=np.array([-1e15, -1e15, 0.0, -1e15, -1e15, -1e15])   #0.05
lowerLimit3=np.array([-1e15, -1e15, 0.0, -1e15, -1e15, -1e15])   #0.08
...
terminalCostModel.addCost("stateReg", xRegTermCost, 1e5) #1e-5
...
problem = crocoddyl.ShootingProblem(x0, [runningModel1] * groundKnots + [runningModel2] * flyingKnots + [runningModel3] * recoveryKnots, terminalModel)
#****************************************************************************
#****************************************************************************
...
ddp.solve(xs, us, 900, False, 1e-7)
