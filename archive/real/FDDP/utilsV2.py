...
def plotSolution(ddp, dirName, num_knots, bounds=True, figIndex=1, figTitle="", show=True):
    ...
    # Plotting the joint state: positions, velocities and acceleration
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(dirName + 'JointPosVelTorques.pdf', dpi = 300, bbox_inches='tight')
...
def logSolution(ddp, timeStep, logPath):
    ...
    for t in range(len(xs)):
        time.append(round(timeStep * t, 3))

    filename = logPath + 'logJointSpace.csv'
    rangeRelJoints = list(range(1, nq)) + list(range(nq + 1, nq + nx-nq))  # Ignore floating base (fixed joints)
    rangeRelAccs = list(range(1, na)) # Acceleration is 6-dim
    XRel = []
    ARel = []
    ...
    with open(filename, 'w', newline='') as f:
        ...
        # TaskSpecific:DynamicWalking the GOOD ONE USED BY JULUIS
        # writer.writerow(['t[s]',
        #                  'q_BodyPitch', 'q_BodyRoll', 'q_BodyYaw',
        ...
        # TaskSpecific:Melya_Manip without and with the wrists
        #writer.writerow(['t[s]',
        #                 'q_BodyPitch', 'q_BodyRoll', 'q_BodyYaw',
        #                 'q_ALShoulder1', 'q_ALShoulder2', 'q_ALShoulder3', 'q_ALElbow',
        #                 'q_ARShoulder1', 'q_ARShoulder2', 'q_ARShoulder3', 'q_ARElbow',
        ...
        # TaskSpecific:Melya_Manip without and with the wrists
        writer.writerow(['t[s]',
                         'q_urdf_hip', 'q_urdf_knee', 

                         'qd_urdf_hip', 'qd_urdf_knee',
                         

                         'qdd_urdf_hip', 'qdd_urdf_knee',
                          

                         'Tau_urdf_hip', 'Tau_urdf_knee'])




        # TaskSpecific:Melya_Manip with the wrists
        #writer.writerow(['t[s]',
        #                 'q_BodyPitch', 'q_BodyRoll', 'q_BodyYaw',
        #                 'q_ALShoulder1', 'q_ALShoulder2', 'q_ALShoulder3', 'q_ALElbow',
        #                 'q_ALWristRoll', 'q_ALWristYaw', 'q_ALWristPitch',
        #                 'q_ARShoulder1', 'q_ARShoulder2', 'q_ARShoulder3', 'q_ARElbow', 
        #                 'q_ARWristRoll', 'q_ARWristYaw', 'q_ARWristPitch',
        #                 'q_LLHip1', 'q_LLHip2', 'q_LLHip3', 'q_LLKnee', 'q_LLAnkleRoll', 'q_LLAnklePitch',
        #                 'q_LRHip1', 'q_LRHip2', 'q_LRHip3', 'q_LRKnee', 'q_LRAnkleRoll', 'q_LRAnklePitch',
        #                 'q_HeadPitch',	'q_HeadRoll', 'q_HeadYaw',

        #                 'qd_BodyPitch', 'qd_BodyRoll', 'qd_BodyYaw',
        #                 'qd_ALShoulder1', 'qd_ALShoulder2', 'qd_ALShoulder3', 'qd_ALElbow',
        #                 'qd_ALWristRoll', 'qd_ALWristYaw', 'qd_ALWristPitch',
        #                  'qd_ARShoulder1', 'qd_ARShoulder2', 'qd_ARShoulder3', 'qd_ARElbow',
        #                 'qd_ARWristRoll', 'qd_ARWristYaw', 'qd_ARWristPitch',
        #                 'qd_LLHip1', 'qd_LLHip2', 'qd_LLHip3', 'qd_LLKnee', 'qd_LLAnkleRoll', 'qd_LLAnklePitch',
        #                 'qd_LRHip1', 'qd_LRHip2', 'qd_LRHip3', 'qd_LRKnee', 'qd_LRAnkleRoll', 'qd_LRAnklePitch',
        #                 'qd_HeadPitch', 'qd_HeadRoll',	'qd_HeadYaw',

        #                 'qdd_BodyPitch', 'qdd_BodyRoll', 'qdd_BodyYaw',
        #                 'qdd_ALShoulder1', 'qdd_ALShoulder2', 'qdd_ALShoulder3', 'qdd_ALElbow',
        #                 'qdd_ALWristRoll', 'qdd_ALWristYaw', 'qdd_ALWristPitch',
        #                 'qdd_ARShoulder1', 'qdd_ARShoulder2', 'qdd_ARShoulder3', 'qdd_ARElbow',
        #                 'qdd_ARWristRoll', 'qdd_ARWristYaw', 'qdd_ARWristPitch',
        #                 'qdd_LLHip1', 'qdd_LLHip2', 'qdd_LLHip3', 'qdd_LLKnee', 'qdd_LLAnkleRoll', 'qdd_LLAnklePitch',
        #                 'qdd_LRHip1', 'qdd_LRHip2', 'qdd_LRHip3', 'qdd_LRKnee', 'qdd_LRAnkleRoll', 'qdd_LRAnklePitch',
        #                 'qdd_HeadPitch', 'qdd_HeadRoll', 'qdd_HeadYaw',

        #                 'Tau_BodyPitch', 'Tau_BodyRoll', 'Tau_BodyYaw',
        #                 'Tau_ALShoulder1', 'Tau_ALShoulder2', 'Tau_ALShoulder3', 'Tau_ALElbow',
        #                  'Tau_ALWristRoll', 'Tau_ALWristYaw', 'Tau_ALWristPitch',
        #                 'Tau_ARShoulder1', 'Tau_ARShoulder2', 'Tau_ARShoulder3', 'Tau_ARElbow',
        #                 'Tau_ARWristRoll', 'Tau_ARWristYaw', 'Tau_ARWristPitch',
        #                 'Tau_LLHip1', 'Tau_LLHip2', 'Tau_LLHip3', 'Tau_LLKnee', 'Tau_LLAnkleRoll', 'Tau_LLAnklePitch',
        #                 'Tau_LRHip1', 'Tau_LRHip2', 'Tau_LRHip3', 'Tau_LRKnee', 'Tau_LRAnkleRoll', 'Tau_LRAnklePitch',
        #                 'Tau_HeadPitch', 'Tau_HeadRoll', 'Tau_HeadYaw'])
    ...
    rangeRelJoints = list(range(0, 1)) + list(range(nq, nq + 1)) # Ignore other joints
    rangeRelAccs = list(range(0, 1)) # Acceleration is 6-dim
    XRel = []
    ARel = []
    sol = []
    ...
    with open(filename, 'w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(['t[s]',
                         'Fx_BodyPitch', 'Fy_BodyPitch', 'Fz_BodyPitch', 'Tx_BodyPitch', 'Ty_BodyPitch', 'Tz_BodyPitch'])
    ...
    rdata = rmodel.createData()
    lfId = rmodel.getFrameId('root_joint')
    rfId = rmodel.getFrameId('root_joint')   #ARWristFT
...
def setLimits(rmodel):
    ...
    # print('Upper position limits: ')
    # print(rmodel.upperPositionLimit)
    # print('Lower position limits: ')
    # print(rmodel.lowerPositionLimit)
    # print('Velocity limits: ')
    # print(rmodel.velocityLimit)
    # print('Torque limits: ')
...
def mergeDataFromSolvers(ddp, bounds):
    ...
    fsArranged = np.zeros((knots,2))#12
    impulse_count = 0
    if bounds:
        us_lb, us_ub = [], []
        xs_lb, xs_ub = [], []
                ...
                if hasattr(data, "differential"):
                    ...
                    for key, contact in data.differential.multibody.contacts.contacts.todict().items():
                        if model.differential.contacts.contacts[key].active:
                            ...
                            if str(contact.joint) == "2": # left foot #TaskSpecific:DynamicWalking "18"
                            ...
                            elif str(contact.joint) == "": #TaskSpecific:DynamicWalking  "24"   #******************************************************************************************************
